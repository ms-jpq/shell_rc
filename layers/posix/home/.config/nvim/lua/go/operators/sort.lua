...
Go.op_sort_lines = function(visual_type)
  ...
  local mode = to.translate_visual_type(visual_type == vim.NIL and "line" or visual_type)
...
vim.keymap.set("v", "gu", to.norm .. [[<cmd>lua Go.op_sort_lines(vim.NIL)<cr>]], {noremap = true})
