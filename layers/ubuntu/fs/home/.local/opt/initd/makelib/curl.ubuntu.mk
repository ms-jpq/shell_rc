...
ifneq (aarch64!!,$(findstring $(MACHTYPE),aarch64)$(findstring !!,$(2)))
...
/usr/bin/pastel                             https://github.com/sharkdp/pastel/releases/latest/download/pastel_0.9.0_$(DPKG_ARCH).deb
