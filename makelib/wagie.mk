...
clobber.wagie:
	rm -vfr -- '$(WAGIE)' '$(COQ)' '$(SNIPS)'

$(COQ): | $(VAR)
	./libexec/git-sync.sh https://github.com/ms-jpq/coq_nvim '$@'

$(SNIPS): | $(VAR)
	./libexec/git-sync.sh https://github.com/ms-jpq/snips '$@'

wagie: $(WAGIE)
$(WAGIE): ./wagie/compile.sh $(WAGIE_HOME)/.zshenv $(WAGIE_RC) $(WAGIE_CONF) $(WAGIE_GEN) | $(COQ) $(SNIPS)
	'$<' '$@' '$(SNIPS)' $(GOOS)
